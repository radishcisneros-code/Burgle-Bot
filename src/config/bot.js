...
export const botConfig = {
    ...
    activities: [
      {
        ...
        state: "HEISTING!",     // this is what people actually see
        type: 4,               // Custom
      },
    ],
  },
  ...
  // =========================
  messages: {
    noPermission: "Greafer dont want you using this command, HAHAHA!",
